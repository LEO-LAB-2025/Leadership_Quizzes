document.addEventListener('DOMContentLoaded', () => {
    ...
    function getFollowershipStyle(independentThinking, activeEngagement) {
        // Check extreme categories first
        if (independentThinking > 40 && activeEngagement > 40) {
        ...
        } else if (independentThinking < 20 && activeEngagement < 20) {
            ...
            // Pragmatist is the catch-all for everyone in the middle range who doesn't fit the extreme categories
